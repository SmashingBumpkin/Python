...
def ex1(int_seq, subtotal):
    ...
    try:
        while 1:
            ...
            while winSum == subtotal:   #counts when window is correct, checks trailing 0s 
...
print(ex1('0,0,3,0,4,0,3,1,0,1,0,1,0,0,5,0,4,2,0,0,9,0',9))
